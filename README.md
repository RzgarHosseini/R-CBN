...
The $\color{blue}{\text{Codes/15\_MutantGeneration.R}}$ R script creates the erroneous genotype files representing false positive and false negative errors of various rates for all the synthetic and simulated genotypic data. <br>
```shell
$ cd Full_Path_to_the_R-CBN_Repository
