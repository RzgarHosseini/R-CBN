...
for (i in 1:N.Quartets){
  ...
  dir.create(paste0(DIR,"/",subDIR,"/",InputFileName,"_n4/R"),recursive=TRUE)
  OutputFileName<-paste0(DIR,"/",subDIR,"/",InputFileName,"_n4/R/Genotype",i,".pat")
  ...
  system(paste0("mkdir ",DIR,"/",subDIR,"/",InputFileName,"_n4/R/Genotype",i))
}
