...
for (i in 1:N.Quartets){
  for (j in 1:219){
    system(paste0("cp ",DIR,"/Data/Posets4/poset",j,".poset ",DIR,"/",subDIR,"/",InputFileName,"_n4/R/Genotype",i,".poset"))
    system(paste0(DIR,"/ct-cbn-0.1.04b/ct-cbn -f ",DIR,"/",subDIR,"/",InputFileName,"_n4/R/Genotype",i,"|tail -1>>",DIR,"/",subDIR,"/",InputFileName,"_n4/R/Results",i,".dat"))
    system(paste0("rm ",DIR,"/",subDIR,"/",InputFileName,"_n4/R/Genotype",i,".poset"))
  }
}
