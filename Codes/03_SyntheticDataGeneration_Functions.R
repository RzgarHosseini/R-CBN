...
# The Mutally exclusive pairs enumerator function
...
#The function generating the compatible genotype set G
...
### Sampling Genotypes using Eq. 11 in the manuscript
